    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.workingTimerOption:
                Intent workIntent = new Intent(pomodoroTimerActivity.this, SetTimeActivity.class);
            ...
            case R.id.breakTimerOption:
                Intent breakIntent = new Intent(pomodoroTimerActivity.this, SetTimeActivity.class);
